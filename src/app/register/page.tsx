    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // In a real app we might put info in a context provider here
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 nano-gradient">
            ...
            <NanoCard className="w-full max-w-md p-12">
                <h1 className="text-4xl font-black uppercase tracking-tightest mb-2">Register.</h1>
                <p className="text-xs font-bold opacity-40 uppercase tracking-widest mb-10">Create Access Credentials</p>
                ...
                <div className="mt-10 text-center">
                    <Link href="/login" className="text-[10px] font-black uppercase tracking-widest opacity-30 hover:opacity-100 transition-all">Existing Assignment Login</Link>
                </div>
            </NanoCard>
        </div>
    );
